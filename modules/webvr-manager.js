...
WebVRManager.prototype.render = function(scene, camera, renderTarget, forceClear) {
  // Scene may be an array of two scenes, one for each eye.
  if (scene instanceof Array) {
    this.effect.render(scene[0], camera, renderTarget, forceClear);
  } else {
    this.effect.render(scene, camera, renderTarget, forceClear);
  }
};
